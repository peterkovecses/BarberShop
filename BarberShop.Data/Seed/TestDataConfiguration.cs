...
namespace BarberShop.Data.Seed
{
    public class TestDataConfiguration
    {
        public static void ConfigureSeedData(ModelBuilder modelBuilder)
        {
            ...
            T WithAudit2<T>(T entity) where T : UserBase
            {
                return entity;
            }
        }
